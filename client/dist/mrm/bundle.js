...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(0), __webpack_require__(2)], __WEBPACK_AMD_DEFINE_RESULT__ = function (require, exports, syncnode_client_1, Components_1) {
    ...
    var MainView = (function (_super) {
        ...
        function MainView(options) {
            ...
            _this.first = false;
            _this.section4_1 = _this.addView(new Section4_1(), 'row-nofill page pad-big border Section4_1_section4_1_style', undefined);
            _this.section9 = _this.add('div', { "innerHTML": "", "className": "row-nofill page pad-big border col div_section9_style row-nofill page pad-big border col" });
            _this.top = _this.add('div', { "parent": "section9", "innerHTML": "", "className": "col-no-fill col-no-fill" });
            _this.title9 = _this.add('h2', { "parent": "top", "innerHTML": "9 Performance Evaluation", "className": "pad-small highlight border-bottom pad-small highlight border-bottom" });
            _this.title9_3 = _this.add('h3', { "parent": "top", "innerHTML": "9.3 Management Review", "className": "pad-small highlight border-bottom pad-small highlight border-bottom" });
            _this.title9_3_1 = _this.add('h4', { "parent": "top", "innerHTML": "9.3.1 General", "className": "pad-small highlight border-bottom pad-small highlight border-bottom" });
            _this.text9_3_1 = _this.add('p', { "parent": "top", "innerHTML": "Top management shall review the organization’s quality management system, at planned intervals, to ensure its continuing suitability, adequacy, effectiveness and alignment with  the strategic direction of the organization.", "className": "highlight highlight" });
            _this.title9_3_2 = _this.add('h4', { "parent": "top", "innerHTML": "9.3.2 Managment Review Inputs", "className": "pad-small highlight border-bottom pad-small highlight border-bottom" });
            _this.tabs = _this.addView(new Components_1.Tabs(), 'col-fill border Tabs_tabs_style', _this.section9);
            _this.section10 = _this.add('div', { "innerHTML": "", "className": "row-nofill page pad-big border row-nofill page pad-big border" });
            _this.title10 = _this.add('h2', { "parent": "section10", "innerHTML": "10 Improvement", "className": "pad-small highlight border-bottom pad-small highlight border-bottom" });
            _this.el.className += ' row';
            _this.addBinding('section4_1', 'update', 'selectedMRM.section4_1');
            return _this;
        }
        ...
        MainView.prototype.addMRM = function () {
            /*
    ...
    var Section4_1 = (function (_super) {
        __extends(Section4_1, _super);
        function Section4_1(options) {
            if (options === void 0) { options = {}; }
            var _this = _super.call(this, syncnode_client_1.SyncUtils.mergeMap({}, options)) || this;
            _this.title4 = _this.add('h2', { "innerHTML": "4 Context of the organization", "className": "highlight border-bottom highlight border-bottom" });
            _this.title4_1 = _this.add('h3', { "innerHTML": "4.1 Understanding the organization and it's context", "className": "highlight border-bottom highlight border-bottom" });
            _this.description = _this.add('p', { "innerHTML": "The organization shall  determine external and internal issues that are relevant to its purpose and its strategic direction and that affect its ability to achieve the intended result(s) of its quality management system.", "className": "highlight highlight" });
            _this.title1 = _this.add('h4', { "innerHTML": "Positive Issues", "className": "" });
            _this.positive = _this.addView(new syncnode_client_1.SyncList({ item: Section4_1Item }), '', undefined);
            _this.addPositive = _this.add('button', { "innerHTML": "New Positive", "className": " button_addPositive_style" });
            _this.title2 = _this.add('h4', { "innerHTML": "Negative Issues", "className": "" });
            _this.negative = _this.addView(new syncnode_client_1.SyncList({ item: Section4_1Item }), '', undefined);
            _this.addNegative = _this.add('button', { "innerHTML": "New Negative", "className": " button_addNegative_style" });
            _this.el.className += ' ';
            _this.addBinding('positive', 'update', 'data.positive');
            _this.addPositive.addEventListener('click', function () {
                _this.data.positive.setItem({
            ...
            _this.addBinding('negative', 'update', 'data.negative');
            _this.addNegative.addEventListener('click', function () {
                _this.data.negative.setItem({
                    createdAt: new Date().toISOString(),
                    occurredAt: new Date().toISOString(),
                    text: '',
                    note: ''
    ...
    var Section4_1Item = (function (_super) {
        __extends(Section4_1Item, _super);
        function Section4_1Item(options) {
            if (options === void 0) { options = {}; }
            var _this = _super.call(this, syncnode_client_1.SyncUtils.mergeMap({}, options)) || this;
            _this.text = _this.addView(new Components_1.TextArea({ key: 'text' }), 'row-fill', undefined);
            _this.el.className += ' row';
            _this.addBinding('text', 'update', 'data');
            return _this;
        }
        return Section4_1Item;
    }(syncnode_client_1.SyncView));
    exports.Section4_1Item = Section4_1Item;
    var SectionA = (function (_super) {
        __extends(SectionA, _super);
        function SectionA(options) {
            if (options === void 0) { options = {}; }
            var _this = _super.call(this, syncnode_client_1.SyncUtils.mergeMap({}, options)) || this;
            _this.title = _this.add('h3', { "innerHTML": "The status of actions from previous management reviews", "className": "highlight highlight" });
            _this.input = _this.addView(new Components_1.TextArea({ key: 'sectionA' }), '', undefined);
            _this.el.className += ' pad-small';
            _this.addBinding('input', 'update', 'data');
            return _this;
        }
        return SectionA;
    }(syncnode_client_1.SyncView));
    exports.SectionA = SectionA;
    var SectionB = (function (_super) {
        __extends(SectionB, _super);
        function SectionB(options) {
            if (options === void 0) { options = {}; }
            var _this = _super.call(this, syncnode_client_1.SyncUtils.mergeMap({}, options)) || this;
            _this.title = _this.add('h3', { "innerHTML": "Changes in external and internal issues that are relevant to the quality management system", "className": "highlight highlight" });
            _this.input = _this.addView(new Components_1.TextArea({ key: 'sectionB' }), '', undefined);
            _this.exceptions = _this.addView(new ExceptionsView(), '', undefined);
            _this.el.className += ' pad-small';
            _this.addBinding('input', 'update', 'data');
            return _this;
        }
        SectionB.prototype.init = function () {
            console.log('sending request');
            var xhr = new XMLHttpRequest();
            xhr.open('GET', 'http://server1.imt.local/imtsqlrest/api/exceptions');
            xhr.onload = function () {
                if (xhr.status === 200) {
                    var results = JSON.parse(JSON.parse(xhr.responseText));
    ...
    var SectionC1 = (function (_super) {
        __extends(SectionC1, _super);
        function SectionC1(options) {
            if (options === void 0) { options = {}; }
            var _this = _super.call(this, syncnode_client_1.SyncUtils.mergeMap({}, options)) || this;
            _this.title = _this.add('h3', { "innerHTML": "Customer satisfaction and feedback from relevant interested parties", "className": "highlight highlight" });
            _this.input = _this.addView(new Components_1.TextArea({ key: 'sectionC1' }), '', undefined);
            _this.el.className += ' pad-small';
            _this.addBinding('input', 'update', 'data');
            return _this;
        }
    ...
    var SectionC2 = (function (_super) {
        __extends(SectionC2, _super);
        function SectionC2(options) {
            if (options === void 0) { options = {}; }
            var _this = _super.call(this, syncnode_client_1.SyncUtils.mergeMap({}, options)) || this;
            _this.title = _this.add('h3', { "innerHTML": "The extent to which quality objectives have been met", "className": "highlight highlight" });
            _this.input = _this.addView(new Components_1.TextArea({ key: 'sectionC2' }), '', undefined);
            _this.el.className += ' pad-small';
            _this.addBinding('input', 'update', 'data');
            return _this;
        }
    ...
    var SectionC3 = (function (_super) {
        __extends(SectionC3, _super);
        function SectionC3(options) {
            if (options === void 0) { options = {}; }
            var _this = _super.call(this, syncnode_client_1.SyncUtils.mergeMap({}, options)) || this;
            _this.title = _this.add('h3', { "innerHTML": "Process performance and conformity of products and services", "className": "highlight highlight" });
            _this.input = _this.addView(new Components_1.TextArea({ key: 'sectionC3' }), '', undefined);
            _this.el.className += ' pad-small';
            _this.addBinding('input', 'update', 'data');
            return _this;
        }
    ...
    var SectionC4 = (function (_super) {
        __extends(SectionC4, _super);
        function SectionC4(options) {
            if (options === void 0) { options = {}; }
            var _this = _super.call(this, syncnode_client_1.SyncUtils.mergeMap({}, options)) || this;
            _this.title = _this.add('h3', { "innerHTML": "Nonconformities and corrective actions", "className": "highlight highlight" });
            _this.input = _this.addView(new Components_1.TextArea({ key: 'sectionC4' }), '', undefined);
            _this.customerConcerns = _this.addView(new CustomerConcernsView(), '', undefined);
            _this.el.className += ' pad-small';
            _this.addBinding('input', 'update', 'data');
            return _this;
        }
        SectionC4.prototype.init = function () {
            console.log('sending request');
            var xhr = new XMLHttpRequest();
    ...
    var SectionC5 = (function (_super) {
        __extends(SectionC5, _super);
        function SectionC5(options) {
            if (options === void 0) { options = {}; }
            var _this = _super.call(this, syncnode_client_1.SyncUtils.mergeMap({}, options)) || this;
            _this.title = _this.add('h3', { "innerHTML": "Monitoring and measurement results", "className": "highlight highlight" });
            _this.input = _this.addView(new Components_1.TextArea({ key: 'sectionC5' }), '', undefined);
            _this.el.className += ' pad-small';
            _this.addBinding('input', 'update', 'data');
            return _this;
        }
    ...
    var SectionC6 = (function (_super) {
        __extends(SectionC6, _super);
        function SectionC6(options) {
            if (options === void 0) { options = {}; }
            var _this = _super.call(this, syncnode_client_1.SyncUtils.mergeMap({}, options)) || this;
            _this.title = _this.add('h3', { "innerHTML": "Audit results", "className": "highlight highlight" });
            _this.input = _this.addView(new Components_1.TextArea({ key: 'sectionC6' }), '', undefined);
            _this.el.className += ' pad-small';
            _this.addBinding('input', 'update', 'data');
            return _this;
        }
    ...
    var SectionC7 = (function (_super) {
        __extends(SectionC7, _super);
        function SectionC7(options) {
            if (options === void 0) { options = {}; }
            var _this = _super.call(this, syncnode_client_1.SyncUtils.mergeMap({}, options)) || this;
            _this.title = _this.add('h3', { "innerHTML": "The performance of external providers", "className": "highlight highlight" });
            _this.input = _this.addView(new Components_1.TextArea({ key: 'sectionC7' }), '', undefined);
            _this.el.className += ' pad-small';
            _this.addBinding('input', 'update', 'data');
            return _this;
        }
    ...
    var SectionD = (function (_super) {
        __extends(SectionD, _super);
        function SectionD(options) {
            if (options === void 0) { options = {}; }
            var _this = _super.call(this, syncnode_client_1.SyncUtils.mergeMap({}, options)) || this;
            _this.title = _this.add('h3', { "innerHTML": "The adequacy of resources", "className": "highlight highlight" });
            _this.input = _this.addView(new Components_1.TextArea({ key: 'sectionD' }), '', undefined);
            _this.el.className += ' pad-small';
            _this.addBinding('input', 'update', 'data');
            return _this;
        }
    ...
    var SectionE = (function (_super) {
        __extends(SectionE, _super);
        function SectionE(options) {
            if (options === void 0) { options = {}; }
            var _this = _super.call(this, syncnode_client_1.SyncUtils.mergeMap({}, options)) || this;
            _this.title = _this.add('h3', { "innerHTML": "The effectiveness of actions taken to address risks and opportunities (see 6.1)", "className": "highlight highlight" });
            _this.input = _this.addView(new Components_1.TextArea({ key: 'sectionE' }), '', undefined);
            _this.el.className += ' pad-small';
            _this.addBinding('input', 'update', 'data');
            return _this;
        }
    ...
    var SectionF = (function (_super) {
        __extends(SectionF, _super);
        function SectionF(options) {
            if (options === void 0) { options = {}; }
            var _this = _super.call(this, syncnode_client_1.SyncUtils.mergeMap({}, options)) || this;
            _this.title = _this.add('h3', { "innerHTML": "Opportunities for improvement", "className": "highlight highlight" });
            _this.input = _this.addView(new Components_1.TextArea({ key: 'sectionF' }), '', undefined);
            _this.el.className += ' pad-small';
            _this.addBinding('input', 'update', 'data');
            return _this;
        }
    ...
    var CustomerConcernsView = (function (_super) {
        __extends(CustomerConcernsView, _super);
        function CustomerConcernsView(options) {
            if (options === void 0) { options = {}; }
            var _this = _super.call(this, syncnode_client_1.SyncUtils.mergeMap({}, options)) || this;
            _this.title = _this.add('h4', { "innerHTML": "Customer Concerns", "className": "border-bottom border-bottom" });
            _this.internal = _this.addView(new ExceptionsResponsibility(), '', undefined);
            _this.external = _this.addView(new ExceptionsResponsibility(), '', undefined);
            _this.undetermined = _this.addView(new ExceptionsResponsibility(), '', undefined);
            _this.el.className += ' ';
            _this.addBinding('internal', 'update', 'data.Internal');
            _this.addBinding('external', 'update', 'data.External');
            _this.addBinding('undetermined', 'update', 'data.Undetermined');
            return _this;
        }
        return CustomerConcernsView;
    }(syncnode_client_1.SyncView));
    exports.CustomerConcernsView = CustomerConcernsView;
    var ExceptionsView = (function (_super) {
        __extends(ExceptionsView, _super);
        function ExceptionsView(options) {
            if (options === void 0) { options = {}; }
            var _this = _super.call(this, syncnode_client_1.SyncUtils.mergeMap({}, options)) || this;
            _this.title = _this.add('h4', { "innerHTML": "Exceptions", "className": "border-bottom border-bottom" });
            _this.internal = _this.addView(new ExceptionsResponsibility(), '', undefined);
            _this.external = _this.addView(new ExceptionsResponsibility(), '', undefined);
            _this.undetermined = _this.addView(new ExceptionsResponsibility(), '', undefined);
            _this.el.className += ' ';
            _this.addBinding('internal', 'update', 'data.exceptions.Internal');
            _this.addBinding('external', 'update', 'data.exceptions.External');
            _this.addBinding('undetermined', 'update', 'data.exceptions.Undetermined');
            return _this;
        }
        return ExceptionsView;
    }(syncnode_client_1.SyncView));
    exports.ExceptionsView = ExceptionsView;
    var ExceptionsResponsibility = (function (_super) {
        __extends(ExceptionsResponsibility, _super);
        function ExceptionsResponsibility(options) {
            if (options === void 0) { options = {}; }
            var _this = _super.call(this, syncnode_client_1.SyncUtils.mergeMap({}, options)) || this;
            _this.name = _this.add('h4', { "innerHTML": "", "className": "" });
            _this.s1 = _this.add('span', { "innerHTML": "", "className": "spancol bold span_s1_style spancol bold" });
            _this.s2 = _this.add('span', { "innerHTML": "2017", "className": "spancol bold center spancol bold center" });
            _this.s3 = _this.add('span', { "innerHTML": "2016", "className": "spancol bold center spancol bold center" });
            _this.s4 = _this.add('span', { "innerHTML": "2015", "className": "spancol bold center spancol bold center" });
            _this.s5 = _this.add('span', { "innerHTML": "2014", "className": "spancol bold center spancol bold center" });
            _this.s6 = _this.add('span', { "innerHTML": "2013", "className": "spancol bold center spancol bold center" });
            _this.s7 = _this.add('span', { "innerHTML": "2012", "className": "spancol bold center spancol bold center" });
            _this.list = _this.add('div', { "innerHTML": "Loading...", "className": "" });
            _this.el.className += ' ';
            _this.addBinding('name', 'innerHTML', 'data.Name');
            return _this;
        }
        ExceptionsResponsibility.prototype.render = function () {
            var _this = this;
            this.list.innerHTML = '';
            syncnode_client_1.SyncUtils.forEach(this.data.Categories, function (cat) {
                var view = new ExceptionsViewCategory();
                view.update(cat);
                _this.list.appendChild(view.el);
            });
        };
        return ExceptionsResponsibility;
    }(syncnode_client_1.SyncView));
    ...
    var ExceptionsViewCategory = (function (_super) {
        __extends(ExceptionsViewCategory, _super);
        function ExceptionsViewCategory(options) {
            if (options === void 0) { options = {}; }
            var _this = _super.call(this, syncnode_client_1.SyncUtils.mergeMap({}, options)) || this;
            _this.s1 = _this.add('span', { "innerHTML": "", "className": "spancol span_s1_style spancol" });
            _this.list = _this.add('span', { "innerHTML": "", "className": "" });
            _this.el.className += ' ';
            _this.addBinding('s1', 'innerHTML', 'data.Name');
            return _this;
        }
        ExceptionsViewCategory.prototype.render = function () {
            var _this = this;
            this.list.innerHTML = '';
            syncnode_client_1.SyncUtils.forEach(this.data.Years, function (year) {
                var span = document.createElement('span');
                span.className = 'spancol center';
                span.innerHTML = year.Count;
                _this.list.appendChild(span);
            });
        };
        return ExceptionsViewCategory;
    }(syncnode_client_1.SyncView));
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(0), __webpack_require__(1)], __WEBPACK_AMD_DEFINE_RESULT__ = function (require, exports, syncnode_client_1, Views_1) {
    ...
    var channel = client.subscribe('mrm');
